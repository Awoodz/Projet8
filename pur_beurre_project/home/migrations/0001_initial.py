# Generated by Django 3.0.8 on 2020-07-22 09:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_product', models.ManyToManyField(blank=True, related_name='product', to='home.Product')),
            ],
        ),
        migrations.CreateModel(
            name='Nutriments',
            fields=[
                ...
                ('nutriments_product_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.Product')),
            ],
        ),
    ]
